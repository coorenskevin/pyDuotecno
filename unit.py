...
class SensUnit(BaseUnit):
    ...
    _state: int = 0
    _preset: int = 0
    _cur_temp: float | None = None
    _setp_sun: float | None = None
    _setp_hsun: float | None = None
    _setp_moon: float | None = None
    _setp_hmoon: float | None = None
    _offset: float | None = None
    _swing_angle: float | None = None
    _working_mode: float | None = None
    _fan_speed: float | None = None
    _swing_mode: float | None = None
    _mode: int = 0
    ...
    def get_cur_temp(self) -> float | None:
